...
player shall report to the NBADL team or NBA Team, whichever isapplicable, within forty-eight (48) hours after such notice is received by the
player.
...
Agreement.(b) Compensation and Benefits.
...
Article XLI. The player's performance in the NBADL
...
Article.(c) Meal Expense. While on the road with his NBADL team, a
player:
...
Assignment or D-League Two-Way Service, the NBADL,the player's NBADL team, the NBA and the player's NBA
...
1/110th of the player's Base Compensation for eachmissed NBADL exhibition, regular season or playoff game
...
missed NBA exhibition, regular season or playoff game,and such player must be maintained on the Team's Active
...
player's NBADL team (other than another player), and (B)the terms "any NBA game or event" will be construed to
...
telecast or broadcast (including NBADL pre-season,exhibition, regular season, or playoff games), (2) the
...
that such player will be required to provide two (2) additional promotionalappearances while on NBADL Work Assignment or D-League Two-Way
...
months and include basketball operations, community relations, sales andmarketing, and/or team coaching rotations. There will be two (2) sessions
